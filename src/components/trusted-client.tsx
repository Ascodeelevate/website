...
export const TrustedClients: React.FC = () => {
  const clients: Client[] = [
    ...
    { name: "Solid Rock Acedemy", logo: "/images/clients/solid-rock-acedemy.png"},
    { name: "The UKPS school", logo:  "/images/clients/the-ukps-school.png" },
    { name: "Crystal Brains School", logo: "/images/clients/crystal-brains-school.png" },
  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-6 text-center">
        ...
        We're honored to work with some of the best companies in the industry, many of which rely on our software.
         </p>
        <div className="flex overflow-x-auto space-x-8 py-4 scrollbar-hide">
          {clients.map((client, index) => (
            <div
              key={index}
              className="flex items-center justify-center min-w-[120px] h-[100px] bg-gray-100 dark:bg-gray-700 rounded-lg shadow-lg"
            >
              <img
                src={client.logo}
                alt={client.name}
