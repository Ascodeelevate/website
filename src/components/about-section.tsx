      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 md:pl-10">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
            At Ascodeelevatesolution, we specialize in teaching modern technical
            skills to various age groups. Our offerings include courses for
            young learners on basic computer operations and software like MS
            Word, PowerPoint, and CorelDraw. For adults, we provide
            comprehensive training in software development, including mobile,
          ...
          <div className="mt-6">
            ...
            <ul className="list-disc list-inside text-lg text-gray-700 dark:text-gray-300 space-y-2">
              <li className="flex items-center">
                ...
                <span>
                  {" "}
                  Helped over <span className="font-semibold">50 schools </span>
